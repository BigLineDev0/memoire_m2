...
class ReservationController extends Controller
{
    public function index()
    {
        ...
        return view('admin.reservations.index', compact('reservations', 'laboratoires'));
    }
    ...
    public function create()
    {
        ...
        return view('admin.reservations.create', compact('users','laboratoires','horaires'));
    }
    ...
    public function store(Request $request)
    {
        ...
        return redirect()->route('admin.reservations.index')->with('success', 'Réservation effectuée et email envoyé.');
    }
    ...
    public function edit(Reservation $reservation)
    {
        ...
        $laboratoires = Laboratoire::with('equipements')->get();
        $horaires = Horaire::all();
        return view('admin.reservations.edit', compact('reservation','users','laboratoires','horaires'));
    }
