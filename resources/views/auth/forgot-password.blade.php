...
<head>
    ...
    <title>Mot de passe oublié - UMRED</title>
                            ...
                            <div class="col-lg-6">
                                <div class="p-5">
                                    <div class="text-center">
                                        ...
                                        <p class="mb-4">
                                            Pas de souci ! Indiquez simplement votre adresse email ci-dessous,
                                    ...
                                    <div class="text-center">
                                        <a class="small" href="{{ route('login') }}">Déjà inscrit ? Connexion</a>
                                    </div>
                                </div>
                            </div>
                        </div>
