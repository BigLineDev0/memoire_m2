...
@section('content')
    <div class="d-sm-flex align-items-center justify-content-between mb-4">
        ...
        <a href="{{ route('chercheur.reservations.create') }}" class="d-none d-sm-inline-block btn btn-sm btn-primary shadow-sm">
                            ...
                            <tr data-labo="{{ $reservation->laboratoire_id }}" data-statut="{{ $reservation->statut }}">
                                ...
                                <td class="text-center">
                                    ...
                                    @if($reservation->statut !== 'annule')
                                        <a href="{{ route('chercheur.reservations.edit', $reservation->id) }}"
                                    ...
                                    {{-- Annuler --}}
                                    @if($reservation->statut !== 'annule')
                                        <form action="{{ route('chercheur.reservations.cancel', $reservation->id) }}" method="POST" class="d-inline"
    ...
    @include('chercheur.reservations.partials.modal-detail')
