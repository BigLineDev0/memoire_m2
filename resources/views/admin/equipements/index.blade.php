...
@section('content')
    <div class="d-sm-flex align-items-center justify-content-between mb-4">
        ...
        <div class="d-none d-sm-inline-block">
            <a href="#" class="btn btn-sm btn-success shadow-sm mr-2" data-toggle="modal" data-target="#importCsvModal">
                <i class="fas fa-file-upload fa-sm text-white-50"></i> Importer un fichier CSV
            </a>
            <a href="{{ route('admin.equipements.create') }}" class="btn btn-sm btn-primary shadow-sm">
                <i class="fas fa-plus fa-sm text-white-50"></i> Nouveau Equipement
            </a>
        </div>
    </div>
                        ...
                        @forelse ($equipements as $equipement)
                            <tr data-labo-ids="{{ $equipement->laboratoires->pluck('id')->implode(',') }}"
                                ...
                                <td class="text-center">
                                    ...
                                    <a href="{{ route('admin.equipements.alert', $equipement) }}"
    ...
    <div class="modal fade" id="importCsvModal" tabindex="-1" role="dialog" aria-labelledby="importCsvModalLabel" aria-hidden="true">
        <div class="modal-dialog" role="document">
            <div class="modal-content">
                ...
                <form action="{{ route('admin.equipements.import') }}" method="POST" enctype="multipart/form-data">
                    @csrf
                    <div class="modal-body">
