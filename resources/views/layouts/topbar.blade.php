            ...
            <div class="dropdown-list dropdown-menu dropdown-menu-right shadow animated--grow-in"
                    ...
                    <a class="dropdown-item d-flex align-items-center" href="#">
                        <div class="mr-3">
                            <div class="icon-circle
                                {{ strtolower($notif->type) === 'maintenance' ? 'bg-danger' : 'bg-primary' }}">
                                <i class="fas
                                    {{ strtolower($notif->type) === 'maintenance' ? 'fa-tools text-white' : 'fa-file-alt text-white' }}">
                                </i>
                            </div>
                        </div>
                ...
                @empty
                    <div class="dropdown-item text-center">
                        <span class="font-weight-bold">Aucune nouvelle notification</span>
                    </div>
                @endforelse

                {{-- Bouton voir toutes les notifications seulement si on en a au moins 2 --}}
            ...
            <div class="modal-dialog" role="document">
                <div class="modal-content">
                    ...
                    <div class="modal-body">
                        Bonjour <strong>{{ auth()->user()->prenom }} {{ auth()->user()->name }}</strong>,
